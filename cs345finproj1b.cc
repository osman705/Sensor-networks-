...
int main (int argc, char *argv[])
{
        ...
        std::string lossModel = "ns3::FriisPropagationLossModel"; //Friis propagation loss model
        std::string atr1 = "Frequency";
        wifiChannel.AddPropagationLoss (lossModel, atr1, DoubleValue(2400000000.0)); // frequency = 2.4GHz
        ...
        mob->SetVelocity(Vector(node1_velocity, 0, 0)); //velocity 20 m/s in x-axis
